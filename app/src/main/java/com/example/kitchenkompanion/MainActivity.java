...
public class MainActivity extends AppCompatActivity {
    //Recipes
    public static String recipe_names[] = {"Chocolate Chip Pancakes", "Taco Meat", "Lasagna", "Banana Bread", "Homemade Mac and Cheese", "Chicken Parmesan", "Classic Waffles", "Baked Potato", "Chicken Pot Pie"};
    public static int list_images[] = {R.drawable.private_list_owner4, R.drawable.private_list_owner4, R.drawable.private_list_owner3,R.drawable.private_list_owner4,R.drawable.private_list_owner4,R.drawable.private_list_owner3,R.drawable.private_list_owner3,R.drawable.private_list_owner2,R.drawable.private_list_owner3};
    public static int recipe_image[] = {R.drawable.recipe_pancakes_image, R.drawable.recipe_tacomeat_image, R.drawable.recipe_lasagna_image, R.drawable.recipe_bananabread_image, R.drawable.recipe_macandcheese_image,
